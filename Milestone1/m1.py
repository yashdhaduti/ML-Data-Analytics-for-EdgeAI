...
for fraction in fractions:
	for epoch in epochs:
		...
		convert_tflite(removed_filters_model, f"pruned_filters_{fraction}_{epoch}")
		file = open("accuracy.txt","a")
		file.write(f"fraction: {fraction}, epoch: {epoch}, accuracy {pruned_model_accuracy}, training time {finetune_time}\n")
		file.close()